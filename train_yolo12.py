...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--imgsz", type=int, default=960, help="Imágenes fuente en 720p (1280x720): 960 es un punto medio entre el estándar YOLO (640) y el tamaño nativo (1280), sin bajar tanto detalle como 640")
    parser.add_argument("--batch", type=int, default=4, help="16 GB VRAM: batch=8 @1280px confirmó OOM en TaskAlignedAssigner con este dataset (VisDrone: muchas cajas por imagen); 4 quedó confirmado como seguro a 1280px — a 960px puede que quepa más, pruébalo o usa -1 para autobatch")
